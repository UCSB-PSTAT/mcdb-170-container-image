            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        sh 'podman run -it --rm localhost/$IMAGE_NAME python -c "import numpy; import scipy; import matplotlib; import pandas; import Bio; import statsmodels; import skimage; import seaborn; import datetime; import os; import shutil; import torch; import torchvision"'
